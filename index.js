...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=628561319757:+62 856-1319-757\n' 
            + 'END:VCARD' 
prefix = '!'
blocked = []          
...
const config = {
    XBOT: '❉TERMOS❉', 
    instagram: 'https://instagram.com/uchiha.danil', 
    nomer: 'wa.me/628561319757',
    youtube: 'https://youtube.com/channel/UCwufIuIazpjXdW6r_PhbZsg', 
    whatsapp: 'https://chat.whatsapp.com/D5mSi1cKN8xD5YpYsHA7um', 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["628561319757@s.whatsapp.net"] 
